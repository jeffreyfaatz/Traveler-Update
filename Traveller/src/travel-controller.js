...
class TravelController {
    ...
    handleDeath(statuses, statusesPath, profileItems) {
        ...
        for (const item in profileItems) {
            if (!specSlotNames.includes(profileItems[item].slotId)) {
                continue;
            }
            if (profileItems[item]._tpl !== checkpointVoucherId) {
                continue;
            }
    ...
    handleExtraction(exitName, statuses, statusesPath) {
